...
void Escena::visualizarGL( ContextoVis & cv )
{
   ...
   cauce->fijarModoSombrPlano(cv.sombr_plano); // Fijamos el modo de sombreado

   if (cv.modo_visu == ModosVisu::relleno) // Fijamos el modo de visualizacion de poligonos
...
Escena1::Escena1()
{
   ...
   objetos.push_back(new CuboColores()); // Añadimos cubo con colores a la lista de objetos
   objetos.push_back(new Tetraedro() ); // Añadimos tetraedro a la lista de objetos
...
Escena2::Escena2()
{
   ...
   objetos.push_back( new Cilindro(9, 10) );
   objetos.push_back( new Cono(11, 10) );
   objetos.push_back( new Esfera(11, 10) );
